...
const Button = (props: ButtonProps) => {
    ...
    const solidColor = () => {
        const btn = {
            // Light mode: Nutriflex blue (primary)
            // Dark mode: Nutriflex pink accent
            bgColor: active
                ? `bg-primary-deep dark:bg-[#fb64b6]`
                : `bg-primary dark:bg-[#fb64b6]`,
            textColor: 'text-neutral',
            hoverColor: active
                ? ''
                : `hover:bg-primary-mild dark:hover:bg-[#fb64b6]`,
            activeColor: ``,
        }
