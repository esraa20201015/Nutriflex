...
const AccordionItemContext = React.createContext<AccordionContextValue | null>(
    null,
)
function Accordion({
    className,
...
function AccordionTrigger({
    ...
    return (
        <div className="flex">
            ...
            >
                {children}
                <FiChevronDown className="text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200" />
            </button>
        </div>
    )
}
